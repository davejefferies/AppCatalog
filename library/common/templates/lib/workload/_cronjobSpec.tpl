{{/* CronJob Spec */}}
{{/* Call this template:
{{ include "common.lib.workload.cronjobSpec" (dict "rootCtx" $rootCtx "objectData" $objectData) -}}
...
objectData:
  ...
  +jobSpec data
*/}}
{{- define "common.lib.workload.cronjobSpec" -}}
...
jobTemplate:
  spec:
    {{- include "common.lib.workload.jobSpec" (dict "rootCtx" $rootCtx "objectData" $objectData) | nindent 4 }}
{{- end -}}
